...
// import unitClasses from "./Unit4_2.module.css";
		...
		<div>
			...
			<Paper className={cls.ContentContainer}>
				...
				<div className={cls.NotesContainer}>
					<div className={cls.ImageContainerLarge}>
						<img
							src={primary_succession}
							alt="Darwin's Finches"
							className={cls.ImageLarge}
						/>
					</div>
				...
				<div className={cls.NotesContainer}>
					...
					<div className={cls.Notes}>
						<p>
							Lichens have a unique ability to grow on rock, along
							with many other surfaces. They can release chemicals
							that help dissolve rock so that the lichens can absorb
							minerals.
						</p>
					</div>
					<div className={cls.NotesContainer}>
						<div className={cls.Notes}>
							...
							<div className={cls.Notes}>
								<p>
									This occurs when an event causes an
									ecosystem to restart, but when soil is
									already present. Pioneer species for
									secondary succession may include{" "}
									<em>
										ferns, mosses, and small weeds
									</em>
									. It really depends on the
									environment, but a common
									characteristic is that these pioneer
									species can grow in shallow possibly
									low nutrient soil.
								</p>
							</div>
						</div>
