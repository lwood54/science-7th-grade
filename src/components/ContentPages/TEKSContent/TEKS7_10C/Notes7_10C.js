	...
	return (
		<Paper className={cls.ContentContainer}>
			...
			<div className={cls.NotesContainer}>
				...
				<div className={cls.Notes}>
					<p className={cls.paragraphContent}>
						Ecological succession occurs whenever an ecosystem is not in
						homeostasis. How long and at what starting point depend on the
			...
			<div className={cls.NotesContainer}>
				<div className={cls.Notes}>
					<p>
						This occurs when an ecosystem is starting from bare rock.
						Whether the bare rock is due to human causes or natural
						events, such as lava flow or earthquakes, primary succession
						must begin by breaking down bare rock.
					</p>
				</div>
				<div className={cls.ImageContainer}>
					<img
			...
			<div className={cls.NotesContainer}>
				<div className={cls.Notes}>
					<p>
						This occurs when an event causes an ecosystem to restart, but
						when soil is already present. Pioneer species for secondary
						succession may include <em>ferns, mosses, and small weeds</em>
						. It really depends on the environment, but a common
						characteristic is that these pioneer species can grow in
						shallow possibly low nutrient soil.
					</p>
				</div>
				<div className={cls.ImageContainer}>
					<img
