...
const notes7_10C = props => {
        return (
                <Paper className={cls.ContentContainer}>
                        <h1 className={cls.TEKSTitle}>{Obj7_10C.teksNum}</h1>
                        <Link to={Obj7_10C.teksQuiz} className={cls.TEKS}>
                                <p style={{ marginTop: '0' }}>
                                        {Obj7_10C.teksContent}
                                </p>
                        </Link>
                        ...
                        <div className={cls.NotesContainer}>
                                ...
                                <div className={cls.Notes}>
                                        <p className={cls.paragraphContent}>
                                                ...
                                                whenever an ecosystem is not in
                                                homeostasis. How long and at
                                                what starting point depend on
                        ...
                        <div className={cls.NotesContainer}>
                                ...
                                <div className={cls.Notes}>
                                        <p>
                                                ...
                                                the difference is that primary
                                                succession starts with bare rock
                                                and secondary succesison starts
                                                with soil.
                                        </p>
                                </div>
                        </div>
                        ...
                        <div className={cls.NotesContainer}>
                                <div className={cls.Notes}>
                                        <p>
                                                This occurs when an ecosystem is
                                                starting from bare rock. Whether
                                                the bare rock is due to human
                                                causes or natural events, such
                                                as lava flow or earthquakes,
                                                primary succession must begin by
                                                breaking down bare rock.
                                        </p>
                                </div>
                                <div className={cls.ImageContainer}>
                                        <img
                        ...
                        <div className={cls.NotesContainer}>
                                ...
                                <div className={cls.Notes}>
                                        <p>
                                                <em>Pioneer Species</em> are
                                                those species that are the first
                                                organisms to establish an
                                                ecosystem.
                                        </p>
                                        <p>
                                                In <em>primary succession</em>,
                                                the most important type of
                                                pioneer species are called{' '}
                                                <em>lichens</em>.
                                        </p>
                                </div>
                        </div>
                        <div className={cls.NotesContainer}>
                                <p className={cls.Notes}>
                                        Lichens have a unique ability to grow on
                                        rock, along with many other surfaces.
                                        They can release chemicals that help
                                        dissolve rock so that the lichens can
                                        absorb minerals.
                                </p>
                                <div className={cls.ImageContainer}>
                                        <img
                        ...
                        <div className={cls.NotesContainer}>
                                ...
                                <p className={cls.Notes}>
                                        Lichens are technically a combination of
                                        algae and fungi living in a symbiotic
                                        relationship. It is their unique ability
                                        to convert radiant energy to sugar,
                                        while also being able to get nutrients
                                        from breaking down organic matter, that
                                        allows them to thrive in otherwise
                        ...
                        <div className={cls.NotesContainer}>
                                <div className={cls.Notes}>
                                        <p>
                                                This occurs when an event causes
                                                an ecosystem to restart, but
                                                when soil is already present.
                                                Pioneer species for secondary
                                                ...
                                                environment, but a common
                                                characteristic is that these
                                                pioneer species can grow in
                                                shallow possibly low nutrient
                                                soil.
                                        </p>
                                </div>
                                <div className={cls.ImageContainer}>
