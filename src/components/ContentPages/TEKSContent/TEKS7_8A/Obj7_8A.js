const obj7_8A = {
        ...
        questions: [
                {
                        text:
                                'Which of the following events is most closely related to a tsunami?',
                        answers: [
                                {
                                        wrong1:
                                                'Churning winds of 75 mph or more?'
                                },
                                {
                                        wrong2:
                                                'A long term reduction in precipitation.'
                                },
                                {
                                        wrong3:
                ...
                {
                        text:
                                'Identify the catastrophic event pictured in this image.',
                        answers: [
                                { wrong1: 'tornado' },
                                { wrong2: 'tsunami' },
                                { wrong3: 'earthquake' },
                ...
                },
                {
                        ...
                        answers: [
                                ...
                                {
                                        wrong3:
                                                'They can erupt, causing the destruction of land.'
                                },
                                {
                                        correct:
                ...
                },
                {
                        ...
                        answers: [
                                {
                                        wrong1:
                                                "Plants don't grow well near volcanoes."
                                },
                                {
                                        wrong2:
                                ...
                                {
                                        wrong3:
                                                'Plants will be unaffected by large volcanic eruptions.'
                                },
                                {
                                        correct:
                ...
                },
                {
                        ...
                        answers: [
                                {
                                        wrong1:
                                                'Hurricanes only occur over land.'
                                },
                                {
                                        wrong2:
                                                'Tornadoes only occur over water.'
                                },
                                {
                                        wrong3:
