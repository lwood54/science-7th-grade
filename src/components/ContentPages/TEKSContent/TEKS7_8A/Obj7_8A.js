const obj7_8A = {
	...
	questions: [
		...
		},
		{
			...
			image: require("./images/volcano.jpg")
		},
		{
			text:
			...
			image: require("./images/volcanic_ash.jpg")
		},
		{
			text:
			...
			image: require("./images/tornado_with_farm.jpg")
		},
		{
		...
		{
			text:
				"Which of the explanations supports the idea that hurricanes can be more destructive than tornadoes?",
			answers: [
				{
					wrong1: "Hurricanes have faster wind speeds than tornadoes."
				},
				{
					wrong2:
						"Tornadoes are not very common, wheras hurricanes are extremely common."
				},
				{
					wrong3:
						"Hurricanes are another name for tornadoes, so their destruction is the same."
				},
				{
					correct:
						"Hurricane wind speeds aren't as fast, but they are larger, last longer, and can bring storm surges and flooding."
				}
			],
			image: require("./images/hurricane_destruction.jpg")
		}
	]
};

export default obj7_8A;
