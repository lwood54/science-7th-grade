...
import dichot_leaves from '../../TEKSContent/TEKS7_11A/images/dichot_leaves.jpg';
        ...
        return (
                <div className={cls.ContentContainer}>
                        ...
                        <Paper className={cls.ContentContainer}>
                                ...
                                <Link
                                        to={Unit4_1Obj.TEKS[0].teksQuiz}
                                        className={cls.TEKS}
                                >
                                        <p style={{ marginTop: '0' }}>
                                                {Unit4_1Obj.TEKS[0].teksContent}
                                        </p>
                                </Link>
                                <div className={cls.NotesContainer}>
                                        <div
                                                className={
                                                        cls.ImageContainerVertical
                                                }
                                        >
                                                <img
                                                        src={dichot_leaves}
                                        ...
                                        <div className={cls.Notes}>
                                                ...
                                                <p>
                                                        ...
                                                        world. Really, they can
                                                        be created to group any
                                                        set of items, however it
                                        ...
                                        <div className={cls.Notes}>
                                                <p>
                                                        So, at for each pair of
                                                        identifying
                                                        characteristics, you
                                                        must choose one that
                                                        best fits the object and
