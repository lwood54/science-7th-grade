...
const unit1_2Obj = {
	...
	game: {
		...
		col5: {
			...
			image: "",
			definition:
				"The result of a change in an object or subject which does not change the chemical makeup"
		}
	},
	game2: {
		col1: {
		...
		col5: {
			...
			image: "",
			definition:
				"The force within the cell that pushes outward towards the cell wall, helping give struture"
		}
	}
};
