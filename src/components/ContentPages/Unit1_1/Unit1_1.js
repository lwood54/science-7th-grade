      ...
      <Paper className={cls.ContentContainer}>
        ...
        <div className={cls.NotesContainer}>
          ...
          <div className={cls.Notes}>
            ...
            <p>
              Cells that work together to perform a common task make up tissue.
              Tissues that work together to perform a common task make up
              organs. Organs working together make up organ systems and finally
              all the organ systems working together make up a functioning
              organism.
            </p>
          </div>
          <div className={cls.Notes}>
